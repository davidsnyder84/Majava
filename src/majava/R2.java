...
//	private static final boolean DEBUG_EXHAUSTED_WALL = true;
	...
	//constructor
	public R2(GameEventBroadcaster eventBroadcaster, Player[] playerArray, Wind roundWindToSet, int roundNum, int roundBonusNum, boolean BUILDER){
		players = playerArray;
	...
	public R2(GameEventBroadcaster eventBroadcaster, Player[] playerArray, Wind roundWindToSet, int roundNum, int roundBonusNum){
		players = playerArray;
		gameEventBroadcaster = eventBroadcaster;
	...
	public R2(GameEventBroadcaster eventBroadcaster, Player[] playerArray, Wind roundWindToSet, int roundNum){this(eventBroadcaster, playerArray, roundWindToSet, roundNum, DEFAULT_ROUND_BONUS_NUM);}
	public R2(GameEventBroadcaster eventBroadcaster, Player[] playerArray){this(eventBroadcaster, playerArray, DEFAULT_ROUND_WIND, DEFAULT_ROUND_NUM);}
	
	public R2 withWall(Wall w){return null;}
	public R2 withPlayers(Player pe, Player ps, Player pw, Player pn){return null;}
