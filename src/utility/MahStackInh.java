...
*/
public class MahStackInh <T> implements Cloneable{
	...
	public MahStackInh(int capacity){mList = new ArrayList<T>(capacity);}
	public MahStackInh(){this(DEFAULT_CAPACITY);}
	
	//copy constructor, duplicates another stack
	public MahStackInh(MahStackInh<T> other){
		this(other.size());
		for (T item: other.mList) mList.add(item);
		
	}
	public MahStackInh<T> clone(){
		return new MahStackInh<T>(this);
	}
...
//	public Iterator<T> iterator(){return mList.iterator();}	//returns the List's iterator
	...
	public static void main(String[] args) {
		...
		MahStackInh<Integer> ints = new MahStackInh<Integer>();
		ints.push(3);
		ints.push(1);
		ints.push(6);
		ints.push(2);
