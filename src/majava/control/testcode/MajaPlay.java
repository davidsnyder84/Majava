...
import majava.util.GlobalSharedVariableBadMan;
...
//		
//		List<List<MeldType>> failures = new ArrayList<List<MeldType>>();
//		List<List<MeldType>> nonFailures = new ArrayList<List<MeldType>>();
//		
//		for (List<MeldType> thisPerm : permutations){
//			GlobalSharedVariableBadMan.order = thisPerm;
//			
//			int numFailures = DemoHandGen.runSimulation(5000);
////			int numFailures = DemoHandGen.runSumulationRandom(500);
//			
//			if (numFailures > 0)
//				failures.add(thisPerm);
//			else
//				nonFailures.add(thisPerm);
//		}
//		
//		println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n-----------FAILURES--------");
//		for (List<MeldType> thisPerm : failures) println(thisPerm.toString());
//		println("\n\n\n**************SUCCESSES***********");
//		for (List<MeldType> thisPerm : failures) println(thisPerm.toString());
//	}
